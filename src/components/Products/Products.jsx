        ...
        <div className={s.products}>
            <div className={s.products__scroll}>
                ...
                <div className={s.products__search}>
                    ...
                    <div className={s.search__item}>
                        <select
                            onChange={(e) => selectChangeHandler(e, "alloys")}
                            value={query.alloys}
                        >
                            <option value="">Все</option>
                ...
                <ul className={s.products__top}>
                    ...
                    <li className={s.products__top_item}>Состояния поставки</li>
                            ...
                            products?.results?.map((product) => {
                                return (
                                    <ul
                                        ...
                                        key={product.id}
                                    >
                                        <li className={s.products__list_item}>
                ...
                <div className={s.pagination__wrap}>
                    <Link
                        href={`/products?alloys=${
                            query?.alloys || "all"
                        }&categories=${query?.categories || "all"}&materials=${
                            query?.materials || "all"
                        }&page=${+page - 1}`}
                    >
                        <ButtonRed
